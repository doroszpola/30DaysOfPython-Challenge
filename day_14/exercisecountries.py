...
languages = reduce(lambda acc, country: acc+country['languages'], data, []) #acc is our [] and it gathers up all the languages // [] is the initializer than can be ommited form the reduce function

print(languages)

most_spoken = Counter(languages).most_common(10)
